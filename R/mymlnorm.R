#' normal max likelihood estimator
#'
#' @param x vector of data
#' @param mu mean of population
#' @param sig standard hdviation of population
#' @param ... variables for the plot
#'
#' @return list of values for max likelihood
#' @export
#'
#' @examples
#' x=1:10
#' mymlnorm(x=x,mu=seq(10,15,length=1000),sig=seq(0.1,4,length=1000))
#'
